/*
 * Задача С2 контеста "продвинутый Си"
 * Польская запись
 * Необходимо вычислить выражение написанное в обратной польской записи.
 *  На вход подается строка состоящая из целых, не отрицательных чисел
 *  и арифметических символов.
 *  В ответ единственное целое число - результат.
 * 
 * Формат ввода:
 * Строка состоящая из целых чисел и символов '+', '-', '*', '/', ' '.
 * В конце строки символ '.'.
 * Строка корректная. Длина строки не превосходит 1000 символов.
